<template>
	<div class="relative h-screen w-full ">
                          <div class="py-10 lg:py-14">
                            ...
                            <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
                              ...
                              <p class="mt-3 text-gray-600 dark:text-gray-400">
                                Vytvorit potravinarskou etiketu na obal hamburger housky se vsemi nalezitostmi
                              </p>
                            </div>
                            <!-- End Title -->
                            ...
                            <ul class="mt-16 space-y-5">
                              ...
                              <li class="max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4">
																<img class="flex-shrink-0 w-[2.375rem] h-[2.375rem] rounded-full" src="https://i.pravatar.cc/64?u=2fake@pravatar.com" />
																<!-- class="flex-shrink-0 w-[2.375rem] h-[2.375rem] rounded-full" width="38" height="38" -->
                                ...
                                <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                                  <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
                                    <span class="flex-shrink-0 inline-flex items-center justify-center h-[2.375rem] w-[2.375rem] rounded-full bg-gray-600">
                                      <span class="text-sm font-medium text-white leading-none">Vy</span>
                                    </span>
                                ...
                                <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
                                  ...
                                  <div class="space-y-3">
                                    <p class="text-sm text-gray-800 dark:text-white">
																			Pro vytvoření potravinářské etikety pro obal hamburger housky je důležité zohlednit několik klíčových aspektů. 
                                    </p>
                                    <div class="space-y-1.5">
                                      <p class="text-sm text-gray-800 dark:text-white">
                                        Název a logo: Začněte vytvořením atraktivního názvu pro vaši hamburger housku, který bude snadno zapamatovatelný a přitažlivý
                                      </p>
                                      <ul>
                                        <li>
                                ...
                                <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                                  <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
                                    ...
                                    <div class="grow mt-2 space-y-3">
                                      ...
                                      <div class="mt-3">
                                        <button type="button" class="p-2 inline-flex justify-center items-center gap-x-1 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-xs dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
                              ...
                              <li class="py-2 sm:py-4">
                                <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
                                  <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
                                    <div>
                                      <div class="text-end">
                                        <button type="button" class="ml-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-md border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm dark:bg-slate-900 dark:text-blue-500 dark:border-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400">
                          ...
                          <footer class="max-w-4xl mx-auto sticky bottom-0 z-10 p-3 sm:py-6">
                            ...
                            <!-- Input -->
                            <div class="relative">
                              <textarea class="p-4 pb-12 block w-full bg-gray-100 border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-800 dark:border-gray-700 dark:text-gray-400" placeholder="Ask me anything..."></textarea>
