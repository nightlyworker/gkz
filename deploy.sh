...
echo 'Build complete'
echo 'Copying files'
ssh -i /home/martin/lab/h2/_infra/v2 root@10.20.40.1 'rm -rf /home/humandesign.zone/dist/*'
rsync -az --delete -e 'ssh -i /home/martin/lab/h2/_infra/v2' dist/ root@10.20.40.1:/home/humandesign.zone/dist
echo 'Copy complete'
echo 'Restarting containter'
ssh -i /home/martin/lab/h2/_infra/v2 root@10.20.40.1 'cd /home/humandesign.zone && docker-compose restart'
